...
class ReceiptController extends AbstractController
{
     ...
     */
    public function payForwardedReceiptAction(Request $request, Receipt $receipt, LoggerInterface $logger)
    {
    ...
    /**
     * @Route("/pay/{numeroReferenciaGTWIN}/{dni}", name="receipt_pay", methods={"GET","POST"}, options={"expose"=true})
     */
