 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\GTWIN\OperacionesExternasRepository",readOnly=true)
 */
class OperacionesExternas
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\GTWIN\MensajesError")
