...
use AppBundle\Entity\ReciboGTWIN;
...
//	}
    ...
    public function findByNumReciboDni( $numRecibo, $dni, $letra ) {
	    $qb = $this->createQueryBuilder('r')
		    ->select()
		    ->leftJoin('AppBundle:GTWIN\TipoIngreso', 't', 'WITH', 'r.tipoIngreso = t.id' );
	    $qb->andWhere('r.numeroRecibo = :numeroRecibo')
	    ->andWhere('r.dni= :dni')
